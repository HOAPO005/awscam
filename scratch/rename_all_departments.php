...
echo "Starting shortening of student codes for ALL departments...\n";
...
foreach ($khoas as $k) {
    ...
    // Get all students in this department ordered by current ma_sv
    ...
    foreach ($students as $index => $sv) {
        ...
        $new_ma_sv = $k->ma_khoa . $num;
        $old_ma_sv = $sv->ma_sv;
        
        // Skip if already shortened to prevent double updates or no-ops
...
echo "Total students successfully renamed and accounts updated: {$total_updated}.\n";
